...
public class Teacher {
    ...
    @SerializedName("wehchatid")
    @Expose
    private String wehchatid;
    @SerializedName("pic")
    @Expose
    private String pic;
    @SerializedName("bpic")
    ...
    public Teacher(Teacher teacher){
        ...
        this.wehchatid = teacher.wehchatid;
    ...
    public String getWehchatid() {
        return wehchatid;
    }

    public void setWehchatid(String wehchatid) {
        this.wehchatid = wehchatid;
    }
